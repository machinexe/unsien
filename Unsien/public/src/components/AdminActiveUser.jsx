...
export function AdminActiveUser() {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get(`${allUsers}/${currentUser._id}?status=active`, {
                params: {
