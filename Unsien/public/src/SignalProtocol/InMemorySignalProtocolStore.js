...
import { storeSessionCipher } from '../utils/APIRoutes.js';
import { getSessionCipher } from '../utils/APIRoutes.js';
...
SignalProtocolStore.prototype = {
    ...
    isTrustedIdentity: function (identifier, identityKey, direction) {
        console.log("in SignalProtocolStore");
    ...
    /* Stores and loads a session cipher */
     storeSessionCipher(identifier, cipher) {
        ...
        //  axios.post(`${storeSessionCipher}/${identifier}`, {
     ...
     loadSessionCipher(identifier) {
        ...
        // const response =  axios.get(`${getSessionCipher}?userId=${identifier}`);
